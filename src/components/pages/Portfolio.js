  ...
  return (
    <div className='content'>
      ...
      <div className='card-container'>
        <div className='cards' >
          <img src={petResQ} alt= "Pet ResQ"/>
          <a href='https://rocky-wildwood-75738.herokuapp.com'><p>Pet ResQ</p></a>
          <a href = "https://github.com/zhou7cathy/pet-resq" ><img className= "github" src={github} alt= "icon of github"/></a>
          <h6>Pet ResQ is a pet-finding tool created for user who wants to be able to quickly report a lost or found pet.</h6>
        </div>
        <div className='cards' >
